...
{
    [Authorize]
    public class ResidentialPropertyRegistrationController : Controller
    {
       private PropertyModel model { get; set; }

        public IOptions<Helpers.AppSettings> AppSettings { get; }

        public ResidentialPropertyRegistrationController(IOptions<PCVM.Web.Helpers.AppSettings> appSettings)
        {
