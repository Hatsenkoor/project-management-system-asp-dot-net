...
{
    [Authorize]
    public class SiteVisitRequestController : Controller
    {
        ...
        public SiteVisitRequestController(IOptions<Helpers.AppSettings> appSettings, IStringLocalizer<ProjectController> localizer, IMemoryCache _Cache)
        {
