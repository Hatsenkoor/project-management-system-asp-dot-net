...
namespace PCVM.Web.Controllers
{
    ...
    public class InventoryController : Controller
    {
        ...
        public InventoryController(IOptions<Helpers.AppSettings> appSettings)
        {
        ...
        public async Task<IActionResult> Index(DashboardModel DashboardModel)
        {
            ...
            var values = Newtonsoft.Json.JsonConvert.SerializeObject(DashboardModel);
            ...
            using (var objectClient = new ApiClient(AppSettings))
            {
                ...
                model1 = await objectClient.Post<DashboardModel>("API/Dashboard/GetDashboard?UserId="+ UserId.ToString(), stringContent, "");
            }
        ...
        //        model = await objectClient.Get<DashboardModel>("API/Dashboard/Dashboard?UserId=", UserId.ToString());
        //    }
        ...
        [HttpGet]
        public IActionResult ValuationView()
        {
            return View();
        }

        [HttpGet]
        public IActionResult PropertyApproval()
        {
            return View();
        }
