...
namespace PCVM.Web.Controllers
{
    ...
    public class ProjectController : Controller
    {
        ...
        public ProjectController(IOptions<Helpers.AppSettings> appSettings, IStringLocalizer<ProjectController> localizer, IMemoryCache _Cache)
        {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            if (browserLang.ToLower() == "en-us")
            {
                ...
                {
                    Text = string.Format("{0}", item.ProjectName + "God"),
