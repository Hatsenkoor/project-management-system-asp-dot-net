...
{
    [Authorize]
    public class SiteVisitDirectorApprovalController : Controller
    {
        ...
        public SiteVisitDirectorApprovalController(IOptions<Helpers.AppSettings> appSettings, IStringLocalizer<ProjectController> localizer, IMemoryCache _Cache)
        {
