...
namespace PCVM.Web.Controllers
{
    ...
    public class ProjectViewController : Controller
    {
        ...
        public ProjectViewController(IOptions<Helpers.AppSettings> appSettings, IStringLocalizer<ProjectController> localizer, IMemoryCache _Cache)
        {
        ...
        public async Task<IActionResult> ProjectRegistration()
        {
        ...
        public async Task<IActionResult> ConsultantRegistration()
        {
        ...
        public async Task<IActionResult> LocationGeometry()
        {
