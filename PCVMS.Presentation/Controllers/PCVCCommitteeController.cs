...
{
    public class PCVCCommitteeController : Controller
    {
        private PropertyModel model { get; set; }

        public IOptions<Helpers.AppSettings> AppSettings { get; }

        public PCVCCommitteeController(IOptions<PCVM.Web.Helpers.AppSettings> appSettings)
        {
        ...
        [HttpGet]
        public IActionResult ValuationDecisionDocument()
        {
            return View();
        }

        [HttpGet]
        public IActionResult ValuationDecisionApprovedView()
        {
            return View();
        }
