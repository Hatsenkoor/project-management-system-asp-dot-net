...
{
    public class SiteVisitViewController : Controller
    {
        private PropertyModel model { get; set; }

        public IOptions<Helpers.AppSettings> AppSettings { get; }

        public SiteVisitViewController(IOptions<Helpers.AppSettings> appSettings)
        {
        ...
        public async Task<IActionResult> SiteSurveyEngineer()
        {
        ...
        public async Task<IActionResult> SiteSurveyPCVC()
        {
