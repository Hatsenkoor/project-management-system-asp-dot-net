...
{
    [Authorize]
    public class ObjectionApprovalController : Controller
    {
        ...
        public ObjectionApprovalController(IOptions<Helpers.AppSettings> appSettings, IStringLocalizer<ProjectController> localizer, IMemoryCache _Cache)
        {
