    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(employees, function(index, employee){
                ...
                html+='<a href="#" onclick="showEmpBar('+"'"+employee.ID+"'"+')" class="depth'+depth+'">'
                html+='<img src="'+employee.ImageUrl+'" onclick="showEmpName('+"'"+employee.Name+"'"+')"/>'                
                html+='<div>'
...
function showEmpName(name)
{
 ...
 function showEmpBar(ID)
 {
     location.replace(RootPath() + "/FertilizerCertificate/Dashboard?id=" + ID);
 }