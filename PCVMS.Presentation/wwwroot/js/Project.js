        ...
        success: function (data1) {
            ...
            for (i = 0; i < data1.length; i++) {
               ...
               // var markup = "<tr><td>" + (i + 1) + "</td><td>" + data.documentName + "</td><td> <a href='" + openlink + "'>Open Document</a></td></tr>";
                var markup = "<tr><td class='text-center text-muted'>" + (i + 1) + "</td><td class='text-center'>Royal Decree</td><td class='text-center'>" + data.documentName +"</td>";
                markup += "<td class='text-center' id='tdAction' name='tdAction'><div class='position-relative'><a class='metismenu-icon' href='" + openlink + "'><i href='" + openlink + "' class='metismenu-icon lnr-book' style='cursor:pointer;margin-left: 10px;' title='view'></i></a><i class='metismenu-icon lnr-trash' style='cursor: pointer;margin-left: 10px;' title='delete'></i></div></td></tr>";
