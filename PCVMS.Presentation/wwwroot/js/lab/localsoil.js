...
$(document).ready(function () {
    ...
    getAllLabSample("Local-Fertilizer-Soil");
        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    ID: 0,
                    Sample_ID: $("#ID").val(),
                    Operation_Number: $("#txtOperationNumber").val(),
                    Fertilizer_Commercial_Name_ID: $("#FertilizerCommonNameMasterID").val(),
                    Fertilizer_Commercial_Name: $("#FertilizerCommonNameMasterID option:selected").text(),
                    Fertilizer_Type_ID: $("#FertilizerTypeMasterID").val(),
                    Fertilizer_Type: $("#FertilizerTypeMasterID option:selected").text(),
                    Element_Analyzed_ID: $("#ElementtobeAnalyzedID").val(),
                    Element_Analyzed_Name: $("#ElementtobeAnalyzedID option:selected").text(),
                    Expected_Harvest_Date: $("#txtProductionDate").val(), //Reading text box values using Jquery
                    Production_Date: $("#txtProductionDate").val(),
                    Expiry_Date: $("#txtExpiryDate").val(),
                    Date_Symptoms_On_Set: $("#txtExpiryDate").val(), 
                    StatusId: "Saved"
        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    Sample_Product_Name: $("#txtSampleProduct").val(),
                    Active_Ingredient_Concentration: $("#txtIngredientAndConcentration").val(),
                    ...
                    Pesticide_Type_ID: $("#PesticideUseID").val(),
                    Pesticide_Type_Name: $("#PesticideUseID option:selected").text(),
                    InstrumentsForAnalysis: $("#txtTradeName").val(),
                    Remark: $("#txtRemark").val(),
                    StatusId: "Saved"
...
//# end Region GENERAL PAGE
    ...
    // Datepicker for Pesticide Certificate
    $('[data-toggle="datepicker_trigger_txtProductionDate"]').datepicker({
        trigger: ".datepicker-click-ProductionDate",
        autoPick: true,
        autoHide: true
    });

    // Datepicker for Pesticide Certificate
    $('[data-toggle="datepicker_trigger_txtExpiryDate"]').datepicker({
        trigger: ".datepicker-click-ExpiryDate",
        autoPick: true,
        autoHide: true
    });
...
function populateLabSampleDetailsGrid(data, status) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var tempString = "<tr>"
            + "<td id = 'tdid' name='tdid'>" + data[i].operation_Number + "</td>"
            + "<td id = 'tdPesticide_Commercial_Name' name = 'tdPesticide_Commercial_Name' style = 'text-align:center;'>" + data[i].fertilizer_Commercial_Name + "</td>"
            + "<td id = 'tdPercentage_Active_Ingredient' name = 'tdPercentage_Active_Ingredient' style = 'text-align:center;'>" + data[i].fertilizer_Type + "</td>"
