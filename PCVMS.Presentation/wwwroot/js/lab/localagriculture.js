...
$(document).ready(function () {
    ...
    getAllLabSample("Local-Agriculture");
        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    ID: 0,
                    Sample_ID: $("#ID").val(),
                    Expected_Harvest_Date: $("#txtExpected_Harvest_Date").val(), //Reading text box values using Jquery
                    Production_Date: $("#txtExpected_Harvest_Date").val(),
                    Expiry_Date: $("#txtExpected_Harvest_Date").val(),
                    Date_Symptoms_On_Set: $("#txtExpected_Harvest_Date").val(),
