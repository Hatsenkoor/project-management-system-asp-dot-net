...
$(document).ready(function () {
    ...
    //# Region Certificate Cancel Section
    ...
    //# endRegion Certificate Cancel Section
...
function populateReviewHistoryGrid(data) {
    ...
    if (data.length > 0)
        $('#pesticide-certificate-cancel-approval').show();
    else
        $('#pesticide-certificate-cancel-approval').hide();
