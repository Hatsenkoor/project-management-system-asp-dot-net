        ...
        $.ajax(
            {
                ...
                url: "CommitteeApproval", // Controller/View
                data: { //Passing data
                    Id: $("#ID").val(),
                    Remark: $("#txtReviewHistory").val(),
                    statusId: "Director Review",
...
function getAllCommitteeCertificate() {

    $.ajax(
        {
            type: "GET", //HTTP POST Method
            url: "getAllCommitteeCertificate", // Controller/View
            success: function (data) {
