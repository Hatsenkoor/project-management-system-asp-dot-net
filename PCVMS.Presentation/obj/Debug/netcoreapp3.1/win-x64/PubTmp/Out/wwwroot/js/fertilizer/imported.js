        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    Exporting_Company: $("#txt_exporting_company").val(),
                    Manufacturing_Country: $("#txt_manufacturing_country").val(), //Reading text box values using Jquery
                    Exporting_Company_Address: $("#txt_exporting_company_address").val(),
                    CR_Number: $("#txt_cr_number").val(),
                    Registered_Commercial_Activities: $("#txt_registered_commercial_activities").val(),
                    Company_Licensed_Import_Export_Trade: $("#txt_company_licensed_import_export_trade").val(),
                    Import_Export_License_Number: $("#txt_import_export_license_number").val(),
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    getAllCertificate("imported");
                    finalsubmissionstatuschange(9, 'Submitted', 'edit');
        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    AppID: $("#ID").val(),
                    PaymentType: "Fertilizer_Imported_Registration_Fee"
                },
                success: function (data) {

                    // window.location.href = RootPath() + "/Checkout/index?Id=556677881" + "&amount=" + $("#txtamount").text();
                    window.location.href = RootPath() + "/Checkout/index?Id=" + data + "&AppID=" + $("#ID").val() + "&amount=" + $("#txtamount").text() + "&paymentType=Fertilizer_Imported_Registration_Fee";
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    if (data.mociCompanyRoot.wsResponseBody.companyOverview.address.state.nameEn.indexOf("Error") === -1) {
                        ...
                        $("#txt_manufacturer").val(data.mociCompanyRoot.wsResponseBody.companyOverview.companyNameArabic);
                        // Populate the Table with Fertilizer Certificate List
                        ...
                        $('#commercial_activities').html(html);
                    } else {
...
function finalsubmissionstatuschange(length, status, event) {
    ...
    if (length === 9 && status === "Saved" && event === 'edit') {
...
function clear() {
    ...
    $("#FertilizerSubcategoryMasterID").val(-1);
    ...
    $("#txt_exporting_company").val('');
    $("#txt_manufacturing_country").val('');
    $("#txt_exporting_company_address").val('');
    $("#txt_cr_number").val('');
    $("#txt_registered_commercial_activities").val('');
    $("#txt_company_licensed_import_export_trade").val('');
    $("#txt_import_export_license_number").val('');
    $("#txt_address").val('');
    $("#txt_remark").val('');
...
//# Region File or Document Upload Download and View
    ...
    var keys = [];
    var keysDefault = ["File1", "File2", "File3", "File4", "File5", "File6", "File7", "File8", "File9"];
...
//# endRegion File or Document Upload Download and View
...
function validatedetailscreen() {
    ...
    if ($("#NatureMasterID option:selected").text() === '') {

        validationControl = validationControl + '<li><i class="metismenu-state-icon pe-7s-ticket" style="margin-right: 10px;"></i>Please, enter value of Nature form</li>';
    }
    ...
    if ($('#txt_exporting_company').val() === '') {

        validationControl = validationControl + '<li><i class="metismenu-state-icon pe-7s-ticket" style="margin-right: 10px;"></i>Please, enter value of Exporting company</li>';
    }
    if ($('#txt_manufacturing_country').val() === '') {

        validationControl = validationControl + '<li><i class="metismenu-state-icon pe-7s-ticket" style="margin-right: 10px;"></i>Please, enter value of Manufacturing country</li>';
    }
    if ($('#txt_exporting_company_address').val() === '') {

        validationControl = validationControl + '<li><i class="metismenu-state-icon pe-7s-ticket" style="margin-right: 10px;"></i>Please, enter value of Exporting company address</li>';
    }
    ...
    if ($('#txt_registered_commercial_activities').val() === '') {

        validationControl = validationControl + '<li><i class="metismenu-state-icon pe-7s-ticket" style="margin-right: 10px;"></i>Please, enter value of Registered commercial activities</li>';
    }
