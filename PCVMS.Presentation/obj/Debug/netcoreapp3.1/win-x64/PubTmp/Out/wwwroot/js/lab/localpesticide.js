...
$(document).ready(function () {
    ...
    getAllLabSample("Local-Pesticide");
        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    Pesticide_Commercial_Name_ID: $("#PesticideCommercialNameID").val(),
                    Pesticide_Commercial_Name: $("#PesticideCommercialNameID option:selected").text(),
                    Percentage_Active_Ingredient: $("#txtPercentageActiveIngredient").val(),
                    Active_Ingredient: $("#txtActiveIngredient").val(),
                    StatusId: "Saved"
...
function populateLabSampleDetailsGrid(data, status) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var tempString = "<tr>"
            ...
            + "<td id = 'tdPesticide_Commercial_Name' name = 'tdPesticide_Commercial_Name' style = 'text-align:center;'>" + data[i].pesticide_Commercial_Name + "</td>"
            + "<td id = 'tdPercentage_Active_Ingredient' name = 'tdPercentage_Active_Ingredient' style = 'text-align:center;'>" + data[i].percentage_Active_Ingredient + "</td>"
