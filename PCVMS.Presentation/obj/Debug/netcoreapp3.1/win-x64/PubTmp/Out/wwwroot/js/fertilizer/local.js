        ...
        $.ajax(
            {
                ...
                data: { //Passing data
                    ...
                    Registered_Commercial_Activities: $('#commercial_activities :selected').text(),
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    if ((data.mociCompanyRoot.companyOverview.companyNameEnglish) === undefined) {

                            $("#txt_manufacturer").val(data.mociCompanyRoot.companyOverview.companyNameArabic);
                        }
                        else {

                            $("#txt_manufacturer").val(data.mociCompanyRoot.companyOverview.companyNameArabic + " " + data.mociCompanyRoot.companyOverview.companyNameEnglish);
                        }
                        // Populate the Table with Fertilizer Certificate List
                        var activities = data.mociCompanyRoot.companyOverview.declaredActivities.activity;
