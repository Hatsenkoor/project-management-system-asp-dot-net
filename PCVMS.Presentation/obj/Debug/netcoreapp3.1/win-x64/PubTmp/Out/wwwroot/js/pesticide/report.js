    ...
    $.ajax(
        {
            ...
            url: RootPath()+ "/PesticideCertificate/GetAllCertificateDefault", // Controller/View
...
function populateRFCDetail() {
    ...
    $.ajax(
        {
            type: "GET", //HTTP POST Method
            url: RootPath() + "/PesticideCertificate/GetAllRemark", // Controller/View
            data: { //Passing data
...
function getAllCommonName(ID) {
    ...
    $.ajax(
        {
            type: "GET", //HTTP POST Method
            url: RootPath() + "/PesticideCertificate/getAllCommonName", // Controller/View
            data: { //Passing data
                CertificateID: $("#ID").val()
            },
            success: function (data) {
