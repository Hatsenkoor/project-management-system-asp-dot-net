...
function populateFertilizerGrid(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var tempString = "<tr>"
            ...
            + "<td style = 'display:none;' id = 'tdManufacturer' name = 'tdManufacturer' style = 'text-align:center;'>" + data[i].manufacturer + "</td>"
            ...
            + "<td id='tdCompany_Licensed_Import_Export_Trade' name='tdCompany_Licensed_Import_Export_Trade'>" + data[i].company_Licensed_Import_Export_Trade + "</td>"
