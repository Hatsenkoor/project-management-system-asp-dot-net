...
$(document).ready(function () {
    ...
    $("#tbl-fertilizer-certificate-approval-list > tbody").on("click", "tr td i", function (evt) {
        ...
        if ($(this).parent("tr").hasClass('active')) {
            ...
            $('#tbl-fertilizer-certificate-approval-list > tbody tr.active').removeClass('active');
       ...
       //end
        ...
        window.location.href = RootPath() + "/PesticideCertificate/approval?CertificateId=" + id;
    ...
    $("#tbl-fertilizer-certificate-review-list > tbody").on("click", "tr td i", function (evt) {
        ...
        if ($(this).parent("tr").hasClass('active')) {
            ...
            $('#tbl-fertilizer-certificate-review-list > tbody tr.active').removeClass('active');
            $(this).parents("tr").addClass("active");
        }
       //end
        ...
        window.location.href = RootPath() + "/PesticideCertificate/review?CertificateId=" + id;
...
function populateReviewGrid(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var tempString = "<tr>"
            ...
            + "<td id = 'tdManufacturer' name = 'tdManufacturer' style = 'text-align:center;'>" + data[i].manufacturer_Company + "</td>"
